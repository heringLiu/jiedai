...
@interface HLGridView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, HeaderViewDelegate, UIActionSheetDelegate, SelectSofa, SelectTechnicianDelegate, UITextFieldDelegate, UIAlertViewDelegate, PickViewDelegate>
