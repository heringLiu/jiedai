...
@interface LJSelectedProjectViewController : UIViewController <topScrollViewMenuDelegate, CustomTopNavigationViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIAlertViewDelegate, UISearchBarDelegate>
